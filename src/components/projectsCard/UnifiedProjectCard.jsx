  ...
  return (
    <div className="p-4 lg:w-1/3 w-full unified-projects-card">
      <div onMouseLeave={handleMouseLeave} onMouseEnter={handleMouseEnter}>
        {isHovered ? (
          <div className="h-96 border border-slate-300 bg-opacity-75 px-8 pt-16 pb-24 rounded-lg overflow-hidden text-center relative glass-effect">
          ...
          <div
            className="h-96 border px-8 pt-16 pb-24 rounded-lg overflow-hidden text-center relative"
            style={{ backgroundColor: "#34194C50", borderColor: "#34194C" }}
          >
            <div
              style={{
                position: "absolute",
            ...
            >
              <img
                src={require(`../../assets/projects/logos/${repo.logo}`)}
                alt="Logo"
              />
            </div>
          </div>
