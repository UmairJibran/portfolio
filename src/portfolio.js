...
const greeting = {
  ...
  extraInfo:
    "I'm Umair Jibran, a software engineer with expertise in serverless computing, AWS, Node.js, and microservices. As the Backend Tech Lead at <strong><a target='_blank' class='custom-underline' href='https://www.productbox.dev'>Productbox</a></strong>, I lead teams to deliver robust and scalable web applications. Passionate about innovation and teamwork, I'm eager to bring my skills to forward-thinking projects in Europe or North America. Outside of tech, I enjoy hiking<img style='display: inline;' src='assets/emojis/hiking.png' alt='Hiking' height=32 width=32 />, playing chess<img style='display: inline;' src='assets/emojis/chess.png' alt='Chess' height=24 width=24 />, cycling 🚴‍♂️, and diving into Game of Thrones<img style='display: inline;' src='assets/emojis/iron-throne.png' alt='Iron Throne' height=24 width=24 />",
  resumeLink:
